...
<?php if ( $prices ) {
    ...
    <div class="price">
        <span class="title-price"><?php echo esc_html__( 'From', 'erios' ); ?></span>
		...
		<?php } else { ?>
            <span class="price_value price_min 1" ><?php echo hb_format_price( $min ) ?></span>
		<?php } ?>

        <span class="unit"><?php esc_html_e( 'Night', 'erios' ); ?></span>
    </div>
<?php } ?>