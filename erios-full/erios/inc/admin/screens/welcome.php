                ...
                <div class="box-import box-shadow mb-30">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 d-flex align-items-center">
                            <div class="row">
                                <div class="col-lg-5 col-md-12">
                                    <div>
                                        <h3 class="large-title c-primary"><?php esc_html_e('Import Demo', 'erios') ?></h3>
                                        <?php if ($status['plugin_required']) { ?>
                                            <p class="text-description"><?php esc_html_e('Please check and make sure that all required plugins are set up on your website', 'erios') ?></p>
                                            <a href="<?php echo esc_url(admin_url('admin.php?page=opal-theme-plugins')); ?>"
                                               class="opal-btn-primary"><?php esc_html_e('Install Plugins', 'erios') ?></a>
                                        <?php } else { ?>
                                            <p class="text-description"><?php esc_html_e('Clone a demo site in few clicks', 'erios') ?></p>
                                            <a href="<?php echo esc_url(admin_url('admin.php?page=opt-ne-click-demo-import')); ?>"
                                               class="opal-btn-primary"><?php esc_html_e('Run Importer', 'erios') ?></a>
                                        <?php } ?>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-12 bl-lg-so-1 d-flex align-items-center">
                            <div class="pl-lg-2">
                                <h2 class="medium-title pb-3 mt-lg-0"><?php esc_html_e('System Status', 'erios') ?></h2>
            ...
            <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 text-center">
                <div class="box-content box-shadow mb-30">
                    <img class="img-auto"
                         ...
                         title="wp opal">
                    <h3><?php esc_html_e('Support Cover', 'erios') ?></h3>
                    <p><?php esc_html_e('We’ll give you a reply within 24 hours except during weekends.', 'erios') ?></p>
                    <div class="box-footer">
                        <a href="https://themelexus.ticksy.com/" target="_blank"
                           class="opal-btn-secondary mt-4"><?php esc_html_e('Submit Ticket', 'erios') ?></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 text-center">
                <div class="box-content box-shadow">
                    <img class="img-auto"
                         ...
                         title="wp opal">
                    <h3><?php esc_html_e('Documentation', 'erios') ?></h3>
                    <p><?php esc_html_e('Read all documentation for our themes. Any questions or training needed for WordPress themes can be  found here.', 'erios') ?></p>
                    <div class="box-footer">
                        <a href="<?php echo esc_url('https://wpdocs.gitbook.io/erios/') ?>" class="opal-btn-primary mt-4"><?php esc_html_e('Explore Now', 'erios') ?></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12 text-center">
                <div class="box-content box-shadow">
                    <img class="img-auto"
                         ...
                         title="wp opal">
                    <h3><?php esc_html_e('Our Information', 'erios') ?></h3>
                    <p><?php esc_html_e('Checkout our site and social for more information.', 'erios') ?></p>
                    <a href="https://www.wpopal.com/"
                       class="mb-3"><?php esc_html_e('www.wpopal.com', 'erios'); ?></a>
